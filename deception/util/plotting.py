...
class Plotting:
    ...
    action_counts_first = {'none': 0, 'row': 0, 'card': 0}      # to plot the percentage of suggestions provided for the first flip
    action_counts_second = {'none': 0, 'row': 0, 'card': 0}     # idem, but for the second flip
